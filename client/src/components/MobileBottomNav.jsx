function MobileBottomNav({ tabs, activeTab, onChange }) {
  return (
    <nav className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-0 pb-0 pt-3 lg:hidden">
      <div className="pointer-events-auto w-full">
        <div className="glass-panel relative overflow-hidden rounded-t-[28px] rounded-b-none border-b-0 px-3 pb-[calc(env(safe-area-inset-bottom,0px)+0.7rem)] pt-2 shadow-panel">
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-14 bg-gradient-to-t from-slate-950/10 to-transparent dark:from-slate-950/30" />
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex min-w-0 flex-1 flex-col items-center gap-1 rounded-[20px] px-3 py-3 text-[11.5px] font-semibold transition ${
                    isActive
