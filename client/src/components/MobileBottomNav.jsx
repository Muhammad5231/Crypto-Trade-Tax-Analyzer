function MobileBottomNav({ tabs, activeTab, onChange }) {
  return (
    <nav className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-4 pb-[calc(env(safe-area-inset-bottom,0px)+0.85rem)] pt-3 lg:hidden">
      <div className="pointer-events-auto mx-auto max-w-lg">
        <div className="glass-panel relative overflow-hidden rounded-[32px] px-2 py-2.5 shadow-panel">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex min-w-0 flex-1 flex-col items-center gap-1.5 rounded-[24px] px-3 py-3 text-[11px] font-semibold transition ${
                    isActive
                ...
                >
                  ...
                  />
                  <Icon className={`h-[18px] w-[18px] transition ${isActive ? 'scale-105' : ''}`} />
